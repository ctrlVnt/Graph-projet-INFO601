...
public class GraphesDeConnaissances {
  ...
  private static HashMap<String, Node<String, Double>> testDijkstraAlgorithm() throws GraphException, IOException, Exception {
    ...
    HashMap<String, Node<String, Double>> dijkstraGraph = dijkstra.dijkstra(graph, new Node<String, Double>(startingCity.getNodeName(), 0.0));
